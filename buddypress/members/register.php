<div id="buddypress">
	...
	<div class="page" id="register-page">
		...
		<div class="section-heading row el-login-frame"></div>
		...
		<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
			...
			<div class="row">
				<div class="register-section col-lg-6" id="el-basic-details-section">
				...
				<div class="register-section col-lg-6" id="el-profile-details-section">
			...
			<?php if ( bp_get_blog_signup_allowed() ) : ?>
				...
				<div class="register-section col-lg-6" id="blog-details-section">
			...
			<div class="submit">
				<input type="submit" name="signup_submit" id="signup_submit" value="<?php esc_attr_e( 'Complete Sign Up', 'buddypress' ); ?>" class="button" />
			</div>
		...
		<?php if ( 'completed-confirmation' == bp_get_current_signup_step() ) : ?>
			...
			<?php if ( bp_registration_needs_activation() ) : ?>
				<p><?php _e( 'Your request for sign up has been received.  Before you can sign in, your account must be activated.  Please allow at least one business day.', 'buddypress' ); ?></p>
			<?php else : ?>
	...
	<div class="signin_options" style="float: left; padding-left: 15px;">

		<p><a href="<?= get_site_url() ?>/wp-login.php">Log In<a/> | <a href="<?= get_site_url() ?>/wp-login.php?action=lostpassword">Lost Password?</a></p>
